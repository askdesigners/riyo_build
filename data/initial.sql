...
INSERT INTO `koken_albums` VALUES (1,'Bez Sítka','shows',NULL,'Premiéra 16. června 1999 \nDerniéra 14. července 2006','Vivamus et nulla volutpat, tincidunt mauris non, interdum lacus. Etiam convallis magna vitae ultrices luctus. ','manual ASC',0,2,2,3,0,1,1427807343,1,9,0,1427722208,1427722208,1428085171,0,'899c2f0f09c2a4dc1ecc12b585e63ae7'),(2,'Active People','people',NULL,'All members currently active in the collective.','All members currently active in the collective.','manual ASC',0,2,10,11,0,0,NULL,NULL,29,0,1427722798,1427722798,1428082187,0,'a30882bde468016c06b7c85b167ea875'),(3,'Active Shows','kto-sa-boji-beatles',NULL,'All the shows in the Riyo Repertoire. ','All the shows in the Riyo Repertoire. ','manual ASC',0,1,1,6,0,0,NULL,NULL,2,0,1427806979,1427806979,1428082187,2,'5056e94ef753f9b6869877a32199e717'),(4,'People','people-1',NULL,'All members past and present','All members','manual ASC',0,1,7,12,0,0,NULL,NULL,2,0,1427807136,1427807136,1428082187,2,'a04d8a19d34925a7d08f367775fc73d0'),(5,'Inactive Members','inactive-members',NULL,'All members currently not active in the collective.','All members currently not active in the collective.','manual ASC',0,2,8,9,0,0,NULL,NULL,11,0,1427807188,1427807188,1428082187,0,'2a5f304bbe69fc9a367df8c8e05a73b7'),(6,'Show 2','show-2',NULL,'Premiéra 16. června 1999 Derniéra 14. července 2006','Premiéra 16. června 1999 Derniéra 14. července 2006','manual ASC',0,2,4,5,0,0,NULL,NULL,2,0,1427807233,1427807233,1428082222,0,'85f42aa3c01cd2975c2f228b739fdebb'),(7,'Premiéra: Brahmáni','show-3',NULL,'A description of the show','Vivamus et nulla volutpat, tincidunt mauris non, interdum lacus.','manual ASC',0,2,14,15,0,1,1427807939,1,3,0,1427807244,1427807244,1428086097,0,'7b970bfaca17555f4ab4a83110b2aa40'),(8,'Inactive Shows','inactive-shows',NULL,'shows that are not currently running.','shows that are not currently running.','manual ASC',0,1,13,16,0,0,NULL,NULL,1,0,1427811127,1427811127,1428082187,2,'61dbf18e6bb0069dcda3ad0b84f0c87e');
...
INSERT INTO `koken_applications` VALUES (6,1,NULL,'d9ae09fd3baae2fa2175be1b603575e1','god',NULL,1435232286,0);
...
INSERT INTO `koken_categories` VALUES (3,'activePerson','activeperson',0,0,15),(4,'inactivePerson','inactiveperson',0,0,14),(5,'activeShow','activeshow',1,0,6),(6,'inactiveShow','inactiveshow',0,0,3);
...
INSERT INTO `koken_join_albums_covers` VALUES (1,1,2),(2,1,1),(3,1,3),(4,2,10),(5,2,11),(6,2,12),(7,5,7),(8,5,10),(9,5,11),(10,6,5),(11,6,6),(12,7,2),(13,7,3),(14,7,4);
...
INSERT INTO `koken_slugs` VALUES ('album.inactive-members'),('album.inactive-shows'),('album.kto-sa-boji-beatles'),('album.people'),('album.people-1'),('album.show-2'),('album.show-3'),('album.shows'),('category.activeperson'),('category.activeshow'),('category.inactiveperson'),('category.inactiveshow'),('content.11-v-kto-sa-boji'),('content.34984-1520224932520-5397771-n'),('content.aktok'),('content.aktovky-reper-nahl'),('content.alesek'),('content.alesek-nahl'),('content.bezsitka-reper-nahl'),('content.brahmani-repertoar-nahl'),('content.cadic'),('content.dagmar-nahled'),('content.daniela-nahled'),('content.davidek-nahled'),('content.equus-repertoar-nahl'),('content.harvey-repertoar-nahl'),('content.idiotka-reper-nahl'),('content.karlos-nahled'),('content.klarin'),('content.klarka-mala'),('content.kompot-reper-nahl'),('content.kto-sa-b'),('content.luca'),('content.mg-0515'),('content.mg-0524'),('content.mg-0550'),('content.mg-0568'),('content.mg-0573'),('content.mg-0625'),('content.mg-0633'),('content.mira'),('content.mozart-program-web-velka'),('content.mysa-nahled'),('content.ondrej'),('content.patris'),('content.petra-nahled'),('content.petros-nahled'),('content.puak'),('content.salome-nahled'),('content.tata-nahl'),('content.tomasek'),('content.vaclav-mala'),('content.veronika-nahled'),('essay.o-nas'),('essay.trocha-historie'),('page.test-page');
...
INSERT INTO `koken_users` VALUES (1,'$2a$08$2TY9mJ13AYefB38CA9oaJONed.PTxeUsPMOxMYXb/x5bSV0eoo4B.','ryan@askdesigners.eu',1427720642,1428080782,'Ryan','Cole','Ryan','Cole','both','ryan@askdesigners.eu',NULL,NULL,NULL,'de7d652770fcc76e8998c9e23cd9ebf3','1e3ec815e9c55619488814533e5abe81');
...
-- Dump completed on 2015-06-25 13:17:12
